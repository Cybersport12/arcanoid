...
background_image='Screenshot 2023-08-13 160427.png'
...
ball = Picture('ball_2.png', 160, 200, 50, 50)
platform = Picture('platform_2.jpg', platform_x, platform_y, 100, 30)
start_x = 5
start_y = 5
count = 9
...
for j in range(3):
  ...
  for i in range (count):
      d = Picture('enemy_2.png',x, y, 50, 50)
      monsters.append(d)
      x = x + 55
  count = count - 1
